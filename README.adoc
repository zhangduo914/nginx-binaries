...
* {nginx-docs-uri}/http/ngx_http_stub_status_module.html[ngx_http_stub_status_module]
* {nginx-docs-uri}/http/ngx_http_v2_module.html[ngx_http_v2_module]
* {nginx-docs-uri}/stream/ngx_stream_core_module.html[ngx_stream_core_module]
* {nginx-docs-uri}/stream/ngx_stream_realip_module.html[ngx_stream_realip_module]
* {nginx-docs-uri}/stream/ngx_stream_ssl_module.html[ngx_stream_ssl_module]
* {nginx-docs-uri}/stream/ngx_stream_ssl_preread_module.html[ngx_stream_ssl_preread_module]
* _All default modules except:_ `http_ssi`, `http_mirror`, `http_geo`, `http_split_clients`, `http_fastcgi`, `http_uwsgi`, `http_scgi`, `http_grpc`, and `http_memcached`

*Extra Modules:* footnote:[Modules that are provided by NGINX but released separately.]

* {nginx-docs-uri}/http/ngx_http_js_module.html[ngx_http_js_module] (except Windows footnote:njs-win32[njs is not supported on Windows, see https://github.com/nginx/njs/issues/320[nginx/njs#320]])
* {nginx-docs-uri}/stream/ngx_stream_js_module.html[ngx_stream_js_module] (except Windows footnote:njs-win32[])
